...
export class CategoryFourComponent implements OnInit {
  ...
  applyParams(categoryOne: string, categoryTwo: string, categoryThree: string, categoryFour: string,
              sort: string, page: number, show: number, type: string) {
    this.router.navigate(['/catalogue', categoryOne, categoryTwo, categoryThree, categoryFour],
